...
function hCSetter() {
    ...
    let imgbackD = document.getElementById('hScore')
...
function aCSetter() {
    ...
    let imgbackC = document.getElementById('aScore')
...
function autooS() {
    if (aT) {
        aT = false
        document.getElementById('hhss').textContent = '';
        document.getElementById('aass').textContent = '';
        cdiv.style.backgroundColor = 'grey'
        cdiv.style.justifyContent = 'left'
    }
    else {
        aT = true
        document.getElementById('hhss').textContent = document.getElementById('homeG').value;
        document.getElementById('aass').textContent = document.getElementById('awayG').value;
...
function homeGG() {
    let hhgg = document.getElementById('hhss')
...
function awayGG() {
    let aagg = document.getElementById('aass')
...
function presetter() {
    if (configData.fotlink) {
        document.getElementById('flink').value = configData.fotlink;
    }
